...
def initConfig():
	...
	setCell( "vk_login", "maks.ryndzak@mail.ru" ) # Логин от аккаунта ВК
	setCell( "vk_password", "farkton2005" ) # Пароль от аккаунта ВК

	setCell( "app_id", 2685278 ) # Приложение, у которого есть доступ взаимодействовать с ВК
	setCell( "telegram_token", "1999006317:AAHpXTwvGMpPBxIgtMInGdGuGbivFQR4XY0" ) # Токен ботинка в Telegram
	...
	setCell( "vk_262462200", '-507814687' ) # Пример переадресации ЛС ВК в Telegram
	setCell( "t_-507814687", '262462200' ) # Пример переадресации ЛС ВК в Telegram

	setCell( "vk_262462200", '-507814687' ) # Пример переадресации из чата ВК в Telegram
	setCell( "t_-507814687", '262462200' ) # Пример переадресации из чата ВК в Telegram
